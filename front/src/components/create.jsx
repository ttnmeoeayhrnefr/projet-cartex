...
export default function Create() {
    ...
    const handleSubmit = async () => {
      console.log(cardAttack, cardDefense, cardAmazonPrice, cardCmktPrice, cardCollection, cardDescription, cardEbayPrice, cardImage, cardName, cardRarity, cardStars, cardTcgPrice, cardType, userId)
      const requestData = {
        nom: cardName,
        type: cardType,
        description: cardDescription,
        image: cardImage ? cardImage.name : '',
        image_cropped: '',
        image_petite: '',
      ...
      console.log(requestData.attaque, requestData.defense, requestData.amazon_price, requestData.cardmarket_price, requestData.set_nom, requestData.description, requestData.ebay_price, requestData.image, requestData.nom, requestData.set_rarete, requestData.etoiles, requestData.tcgplayer_price, requestData.type, requestData.id_user);
